...
namespace Ipfs.Registry
{
    ...
    public class HashingAlgorithm
    {
        ...
        static HashingAlgorithm()
        {
            ...
            Register("shake-128", 0x18, 128 / 8, () => new BouncyDigest(new BC.ShakeDigest(128), 128 / 8));
            Register("shake-256", 0x19, 256 / 8, () => new BouncyDigest(new BC.ShakeDigest(256), 256 / 8));
